...
class CashDeposit extends Component {
    ...
    handlerSubmit = (event) => {
       ...
       const id=this.state.id
        ...
        axios.put('http://192.168.43.217:8080/api/v1/account/' + id + '/deposit/' + balance)
        .then(res => {
            console.log(res)
            ...
            <div className="container">
                <div className="card pl-2 pt-1 pb-1 pr-2 mt-5  " >
                    <div className="jumbotron">
                        <h1 className="display-6">Cash Deposit</h1>
                    </div>
                        <div className="FormCenter">
                            <form onSubmit={this.handlerSubmit.bind(this)} className="FormFields">
                                ...
                                <div>
                                    <Button type="submit" className="btn btn-success w-50 mt-1">Cash Deposit</Button>
                                </div>
